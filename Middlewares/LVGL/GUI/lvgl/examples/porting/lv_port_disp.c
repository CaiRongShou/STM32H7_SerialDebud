 ...
 *   GLOBAL FUNCTIONS
 **********************/
lv_disp_drv_t *disp_drv1;                         /*Descriptor of a display driver*/
...
//    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, MY_DISP_HOR_RES * 80);   /*Initialize the display buffer*/
    ...
    /* Example for 2) */
    static lv_disp_draw_buf_t draw_buf_dsc_1;
    __attribute__((section(".lvgl"))) static lv_color_t buf_2_1[MY_DISP_HOR_RES * 80];                        /*A buffer for 10 rows*/
    __attribute__((section(".lvgl"))) static lv_color_t buf_2_2[MY_DISP_HOR_RES * 80];                        /*An other buffer for 10 rows*/
...
// 
    ...
    disp_drv1->draw_buf = &draw_buf_dsc_1;
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
	...
	LVGL_Color_Fill(area->x1,area->y1,area->x2,area->y2,(uint16_t *)color_p);
	disp_drv1 = disp_drv;
    /*IMPORTANT!!!
